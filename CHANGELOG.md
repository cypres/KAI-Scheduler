...
- Fixed operator reconcile loop on AKS caused by cloud-provider-injected webhook `namespaceSelector` rules being wiped on every reconcile. #1292 [cypres](https://github.com/cypres)
